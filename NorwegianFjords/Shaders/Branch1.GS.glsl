...
void main()
{
	...
	{
		w_position = bezier(i / no_of_generated_points, control_p1_b1, control_p2_b1, control_p3_b1, control_p4_b1);
		w_normal = vec3(0, 1, 0);
		texture_coord = vec2(0, 0);
		gl_Position = Projection * View * vec4(bezier(i/no_of_generated_points, control_p1_b1, control_p2_b1, control_p3_b1, control_p4_b1), 1); EmitVertex();
		w_position = translateX(bezier(i / no_of_generated_points, control_p1_b1, control_p2_b1, control_p3_b1, control_p4_b1), thickness);
		w_normal = vec3(0, 1, 0);
		texture_coord = vec2(1, 0);
		gl_Position = Projection * View * vec4(translateX(bezier(i/no_of_generated_points, control_p1_b1, control_p2_b1, control_p3_b1, control_p4_b1), thickness), 1); EmitVertex();
		w_position = bezier((i + 1) / no_of_generated_points, control_p1_b1, control_p2_b1, control_p3_b1, control_p4_b1);
		w_normal = vec3(0, 1, 0);
		texture_coord = vec2(0, 1);
		gl_Position = Projection * View * vec4(bezier((i+1)/no_of_generated_points, control_p1_b1, control_p2_b1, control_p3_b1, control_p4_b1), 1); EmitVertex();
		w_position = translateX(bezier((i + 1) / no_of_generated_points, control_p1_b1, control_p2_b1, control_p3_b1, control_p4_b1), thickness);
		w_normal = vec3(0, 1, 0);
		texture_coord = vec2(1, 1);
		gl_Position = Projection * View * vec4(translateX(bezier((i+1)/no_of_generated_points, control_p1_b1, control_p2_b1, control_p3_b1, control_p4_b1), thickness), 1); EmitVertex();
	}
	EndPrimitive();

	// Right Branch 1's Mountain
	textureNo = 2;
	for(float i = 0; i < no_of_generated_points; i++)
	{
		texture_coord = vec2(0, 0);
		gl_Position = Projection * View * vec4(bezier(i/no_of_generated_points, control_p1_b1, control_p2_b1, control_p3_b1, control_p4_b1), 1); EmitVertex();
		texture_coord = vec2(1, 0);
		gl_Position = Projection * View * vec4(translateY(translateX(bezier(i/no_of_generated_points, control_p1_b1, control_p2_b1, control_p3_b1, control_p4_b1), -1.5f * thickness), 2f), 1); EmitVertex();
		texture_coord = vec2(0, 1);
		gl_Position = Projection * View * vec4(bezier((i+1)/no_of_generated_points, control_p1_b1, control_p2_b1, control_p3_b1, control_p4_b1), 1); EmitVertex();
		texture_coord = vec2(1, 1);
		gl_Position = Projection * View * vec4(translateY(translateX(bezier((i+1)/no_of_generated_points, control_p1_b1, control_p2_b1, control_p3_b1, control_p4_b1), -1.5f * thickness), 2f), 1); EmitVertex();
	}
	EndPrimitive();
